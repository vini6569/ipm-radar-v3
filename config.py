...
# Controle econômico das consultas: 900 s = 15 min
INTERVALO_RADAR = int(os.getenv("INTERVALO_RADAR", "900"))
...
PRE_LIVE_JANELA_MINUTOS = int(
    os.getenv("PRE_LIVE_JANELA_MINUTOS", "180")
)
...
Q_MAX = float(os.getenv("Q_MAX", "3.00"))
