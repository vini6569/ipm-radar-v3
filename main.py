...
print("ERRO TELEGRAM:", type(erro).name, erro)
return False
...
print("ERRO AO SALVAR CONTROLE:", type(erro).name, erro)
...
print("ERRO AO CARREGAR CONTROLE:", type(erro).name, erro)
...
print("ERRO AO BUSCAR ODDS:", type(erro).name, erro)
odds = []
