...
def extrair_mercados(
    ...
    """
    Extrai e organiza os mercados de odds
    de um determinado evento.

    IMPORTANTE:
    Esta função é exportada explicitamente
    para ser usada pelo main.py.
    """
    ...
    esc, fin, atq = _extrair_estatisticas(
        jogo
    )
