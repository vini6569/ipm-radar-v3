...
def buscar_odds_multiplos(eventos):
    ...
    # ========================================================
    # IMPORTANTE:
    # A ODDS API ACEITA NO MÁXIMO 10 EVENT IDS POR CONSULTA
    # ========================================================
...
def extrair_mercados(
    ...
    # Q PRÉ-LIVE
    #
    # Q = RAIZ(ODD CASA × ODD VISITANTE)
    #
    # ESTE CÁLCULO NÃO É ALTERADO.
    # ========================================================
